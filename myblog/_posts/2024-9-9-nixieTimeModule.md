...
When in config, it hosts its own wifi access-point. From here, the user can set WiFi credentials and their timezone - both of which are stored in the ESP01's flash, allowing it to persist power cycles. 
